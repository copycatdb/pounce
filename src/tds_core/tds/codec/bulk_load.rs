    ...
    S: AsyncRead + AsyncWrite + Unpin + Send,
{
    ...
    pub async fn send(&mut self, row: TokenRow<'a>) -> crate::tds_core::Result<()> {
    ...
    /// table.
    pub async fn finalize(mut self) -> crate::tds_core::Result<ExecuteResult> {
    ...
    async fn write_packets(&mut self) -> crate::tds_core::Result<()> {
