use crate::tds_core::{error::Error, sql_read_bytes::SqlReadBytes, tds::numeric::Numeric, ColumnData};

pub(crate) async fn decode<R>(src: &mut R, len: u8) -> crate::tds_core::Result<ColumnData<'static>>
where
