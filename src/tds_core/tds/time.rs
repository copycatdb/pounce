...
use crate::tds_core::{tds::codec::Encode, SqlReadBytes};
...
impl Encode<BytesMut> for DateTime {
    fn encode(self, dst: &mut BytesMut) -> crate::tds_core::Result<()> {
...
impl Time {
    ...
    pub(crate) fn len(self) -> crate::tds_core::Result<u8> {
        Ok(match self.scale {
            0..=2 => 3,
            3..=4 => 4,
            5..=7 => 5,
            _ => {
                return Err(crate::tds_core::Error::Protocol(
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: usize) -> crate::tds_core::Result<Time>
    where
        R: SqlReadBytes + Unpin,
    {
...
impl DateTime2 {
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: usize) -> crate::tds_core::Result<Self>
    where
        R: SqlReadBytes + Unpin,
    {
...
impl DateTimeOffset {
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: u8) -> crate::tds_core::Result<Self>
    where
        R: SqlReadBytes + Unpin,
    {
