...
pub struct Column {
    ...
    pub(crate) type_info: Option<crate::tds_core::tds::codec::TypeInfo>,
...
impl Column {
    ...
    pub fn new(name: String, column_type: ColumnType) -> Self {
        Self { name, column_type, type_info: None, nullable: None }
    }
    ...
    pub fn type_info(&self) -> Option<&crate::tds_core::tds::codec::TypeInfo> {
...
///
/// ```
/// # use crate::tds_core::{Config, FromSqlOwned};
...
impl Row {
    ...
    #[track_caller]
    pub fn try_get<'a, R, I>(&'a self, idx: I) -> crate::tds_core::Result<Option<R>>
    where
        R: FromSql<'a>,
        I: QueryIdx,
    {
