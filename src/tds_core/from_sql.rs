use crate::tds_core::{tds::Numeric, xml::XmlData, ColumnData};
use uuid::Uuid;
    ...
    Self: Sized + 'a,
{
    ...
    fn from_sql(value: &'a ColumnData<'static>) -> crate::tds_core::Result<Option<Self>>;
}
    ...
    Self: Sized,
{
    ...
    fn from_sql_owned(value: ColumnData<'static>) -> crate::tds_core::Result<Option<Self>>;
}
...
impl FromSqlOwned for XmlData {
    fn from_sql_owned(value: ColumnData<'static>) -> crate::tds_core::Result<Option<Self>> {
        match value {
            ...
            v => Err(crate::tds_core::Error::Conversion(
