...
use crate::tds_core::error::Error;
...
mod tests {
    ...
    #[test]
    fn server_parsing_no_jdbc_no_browser() -> crate::tds_core::Result<()> {
        let test_str = "jdbc:sqlserver://my-server.com:4200";
        let jdbc: JdbcConfig = test_str.parse()?;
        let server = jdbc.server()?;
    ...
    fn server_parsing_with_browser() -> crate::tds_core::Result<()> {
        let test_str = "jdbc:sqlserver://my-server.com\\MSSQLTEST";
        let jdbc: JdbcConfig = test_str.parse()?;
        let server = jdbc.server()?;
    ...
    fn server_parsing_with_browser_and_port() -> crate::tds_core::Result<()> {
        let test_str = "jdbc:sqlserver://my-server.com\\MSSQLTEST:666";
        let jdbc: JdbcConfig = test_str.parse()?;
        let server = jdbc.server()?;
