...
impl FromStr for AdoNetConfig {
    type Err = crate::tds_core::error::Error;

    fn from_str(s: &str) -> crate::tds_core::Result<Self> {
        let dict = s.parse()?;
        Ok(Self { dict })
    }
}
...
impl ConfigString for AdoNetConfig {
    ...
    fn server(&self) -> crate::tds_core::Result<ServerDefinition> {
        fn parse_port(parts: &[&str]) -> crate::tds_core::Result<Option<u16>> {
        ...
        fn parse_server(parts: Vec<&str>) -> crate::tds_core::Result<ServerDefinition> {
            if parts.is_empty() || parts.len() >= 3 {
                return Err(crate::tds_core::Error::Conversion("Server value faulty.".into()));
            }
...
mod tests {
    use super::*;
    use crate::tds_core::client::AuthMethod;
    ...
    use crate::tds_core::EncryptionLevel;

    #[test]
    fn server_parsing_no_browser() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn server_parsing_no_tcp() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn server_parsing_local() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn server_parsing_local_no_tcp() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn server_parsing_no_port() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn server_parsing_with_browser() -> crate::tds_core::Result<()> {
        let test_str = "server=tcp:my-server.com\\MSSQLTEST";
        let ado: AdoNetConfig = test_str.parse()?;
        let server = ado.server()?;

        assert_eq!(Some("my-server.com".to_string()), server.host);
        assert_eq!(None, server.port);
        assert_eq!(Some("MSSQLTEST".to_string()), server.instance);

        let test_str = "data source=tcp:my-server.com\\MSSQLTEST";
        let ado: AdoNetConfig = test_str.parse()?;
        let server = ado.server()?;
    ...
    #[test]
    fn server_parsing_with_browser_and_port() -> crate::tds_core::Result<()> {
        let test_str = "server=tcp:my-server.com\\MSSQLTEST,666";
        let ado: AdoNetConfig = test_str.parse()?;
        let server = ado.server()?;
        ...
        let test_str = "data source=tcp:my-server.com\\MSSQLTEST,666";
        let ado: AdoNetConfig = test_str.parse()?;
        let server = ado.server()?;
    ...
    #[test]
    fn database_parsing() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_true() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_false() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_yes() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_no() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_missing() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_faulty() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn trust_cert_ca_parsing_ok() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn parsing_sql_server_authentication() -> crate::tds_core::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_sspi_authentication() -> crate::tds_core::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_windows_authentication() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn parsing_database() -> crate::tds_core::Result<()> {
    ...
    #[test]
    fn parsing_login_credentials_escaping() -> crate::tds_core::Result<()> {
    ...
    fn encryption_parsing_on() -> crate::tds_core::Result<()> {
    ...
    fn encryption_parsing_off() -> crate::tds_core::Result<()> {
    ...
    fn encryption_parsing_plaintext() -> crate::tds_core::Result<()> {
    ...
    fn encryption_parsing_missing() -> crate::tds_core::Result<()> {
        let test_str = "";
        let ado: AdoNetConfig = test_str.parse()?;
    ...
    #[test]
    fn application_name_parsing() -> crate::tds_core::Result<()> {
