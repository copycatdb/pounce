...
impl FromStr for AdoNetConfig {
    type Err = crate::tabby::error::Error;

    fn from_str(s: &str) -> crate::tabby::Result<Self> {
        let dict = s.parse()?;
        Ok(Self { dict })
    }
}
...
impl ConfigString for AdoNetConfig {
    ...
    fn server(&self) -> crate::tabby::Result<ServerDefinition> {
        fn parse_port(parts: &[&str]) -> crate::tabby::Result<Option<u16>> {
        ...
        fn parse_server(parts: Vec<&str>) -> crate::tabby::Result<ServerDefinition> {
            if parts.is_empty() || parts.len() >= 3 {
                return Err(crate::tabby::Error::Conversion("Server value faulty.".into()));
            }
...
mod tests {
    use super::*;
    use crate::tabby::client::AuthMethod;
    ...
    use crate::tabby::EncryptionLevel;

    #[test]
    fn server_parsing_no_browser() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_no_tcp() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_local() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_local_no_tcp() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_no_port() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_with_browser() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn server_parsing_with_browser_and_port() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn database_parsing() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_true() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_false() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_yes() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_no() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_missing() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_parsing_faulty() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn trust_cert_ca_parsing_ok() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn parsing_sql_server_authentication() -> crate::tabby::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_sspi_authentication() -> crate::tabby::Result<()> {
    ...
    #[test]
    #[cfg(windows)]
    fn parsing_windows_authentication() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn parsing_database() -> crate::tabby::Result<()> {
    ...
    #[test]
    fn parsing_login_credentials_escaping() -> crate::tabby::Result<()> {
    ...
    fn encryption_parsing_on() -> crate::tabby::Result<()> {
    ...
    fn encryption_parsing_off() -> crate::tabby::Result<()> {
    ...
    fn encryption_parsing_plaintext() -> crate::tabby::Result<()> {
    ...
    fn encryption_parsing_missing() -> crate::tabby::Result<()> {
        let test_str = "";
        let ado: AdoNetConfig = test_str.parse()?;
    ...
    #[test]
    fn application_name_parsing() -> crate::tabby::Result<()> {
