    ...
    S: AsyncRead + AsyncWrite + Unpin + Send,
{
    ...
    pub async fn send(&mut self, row: TokenRow<'a>) -> crate::tabby::Result<()> {
    ...
    /// table.
    pub async fn finalize(mut self) -> crate::tabby::Result<ExecuteResult> {
    ...
    async fn write_packets(&mut self) -> crate::tabby::Result<()> {
