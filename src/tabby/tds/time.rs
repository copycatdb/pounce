...
use crate::tabby::{tds::codec::Encode, SqlReadBytes};
...
impl Encode<BytesMut> for DateTime {
    fn encode(self, dst: &mut BytesMut) -> crate::tabby::Result<()> {
...
impl Time {
    ...
    pub(crate) fn len(self) -> crate::tabby::Result<u8> {
        Ok(match self.scale {
            0..=2 => 3,
            3..=4 => 4,
            5..=7 => 5,
            _ => {
                return Err(crate::tabby::Error::Protocol(
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: usize) -> crate::tabby::Result<Time>
    where
        R: SqlReadBytes + Unpin,
    {
...
impl DateTime2 {
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: usize) -> crate::tabby::Result<Self>
    where
        R: SqlReadBytes + Unpin,
    {
...
impl DateTimeOffset {
    ...
    pub(crate) async fn decode<R>(src: &mut R, n: usize, rlen: u8) -> crate::tabby::Result<Self>
    where
        R: SqlReadBytes + Unpin,
    {
