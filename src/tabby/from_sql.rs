use crate::tabby::{tds::Numeric, xml::XmlData, ColumnData};
use uuid::Uuid;
    ...
    Self: Sized + 'a,
{
    ...
    fn from_sql(value: &'a ColumnData<'static>) -> crate::tabby::Result<Option<Self>>;
}
    ...
    Self: Sized,
{
    ...
    fn from_sql_owned(value: ColumnData<'static>) -> crate::tabby::Result<Option<Self>>;
}
...
impl FromSqlOwned for XmlData {
    fn from_sql_owned(value: ColumnData<'static>) -> crate::tabby::Result<Option<Self>> {
        match value {
            ...
            v => Err(crate::tabby::Error::Conversion(
