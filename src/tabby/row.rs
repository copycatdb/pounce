...
pub struct Column {
    ...
    pub(crate) type_info: Option<crate::tabby::tds::codec::TypeInfo>,
...
impl Column {
    ...
    pub fn type_info(&self) -> Option<&crate::tabby::tds::codec::TypeInfo> {
...
///
/// ```
/// # use crate::tabby::{Config, FromSqlOwned};
...
impl Row {
    ...
    #[track_caller]
    pub fn try_get<'a, R, I>(&'a self, idx: I) -> crate::tabby::Result<Option<R>>
    where
        R: FromSql<'a>,
        I: QueryIdx,
    {
